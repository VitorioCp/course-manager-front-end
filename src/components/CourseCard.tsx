...
export default function CourseCard({ course, onDelete, onEdit }: CourseCardProps) {
  return (
    <div className="bg-zinc-900 rounded overflow-hidden shadow hover:shadow-lg transition-shadow">
      <img src={course.img} alt={course.titulo} className="w-full h-40 object-cover" />
      <div className="p-4">
        ...
        <div className="flex gap-2 mt-4">
          <button onClick={onEdit} className="bg-gray-700 hover:bg-gray-600 text-sm px-3 py-1 rounded">
            Editar
          </button>
          <button
            onClick={() => {
